	...
	!e.DUOSHUO) {
		...
		q = function() {
			if (!c && (c = e.duoshuoQuery)) {
				...
				void alert("你还没有设置多说域名(duoshuoQuery.short_name)，填入已有域名或创建新站点：https://duoshuo.com/create-site/");
		...
		var Z = {
			...
			avatarUrl: function(e) {
				let avatar = e.avatar_url || rt.data.default_avatar_url
				avatar = avatar.replace(/^http:\/\//ig, "https://")
				// console.log(avatar)
				return avatar
			},
		...
		et = S.templates = {
			...
			poweredBy: function(e) {
				return '<p class="ds-powered-by"><a href="https://duoshuo.com" target="_blank" rel="nofollow">' + _(e) + "</a></p>"
			},
		...
		et.dialog = function(e) {
			var t = '<div class="ds-dialog"><div class="ds-dialog-inner ds-rounded"><div class="ds-dialog-body">' + e + '</div><div class="ds-dialog-footer"><a href="https://duoshuo.com/" target="_blank" class="ds-logo"></a><span>社会化评论框</span></div><a class="ds-dialog-close" href="javascript:void(0)" title="关闭"></a></div></div>';
			return t
		},
		...
		et.notify = function(e) {
			var t = '<div id="ds-reset"><a class="ds-logo" href="https://duoshuo.com/" target="_blank" title="多说"></a><ul class="ds-notify-unread"><li';
		...
		function() {
			...
			function g(e) {
				if ("https://duoshuo.com" === e.origin) switch (e.data.type) {
				case "login":
