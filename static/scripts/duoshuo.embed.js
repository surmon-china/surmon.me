	...
	!e.DUOSHUO) {
		...
		var Z = {
			...
			avatarUrl: function(e) {
				...
				avatar = avatar.replace(/^http:\/\//ig, "/proxy/")
				// console.log(avatar)
				return avatar
			},
