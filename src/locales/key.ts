...
export enum LocalesKey {
  ...
  AI_CHAT_WELCOME = 'ai-chat-welcome',
  AI_CHAT_SEND_BUTTON = 'ai-chat-send-button',
  AI_CHAT_STOP_BUTTON = 'ai-chat-stop-button',
  AI_CHAT_RESET_BUTTON = 'ai-chat-reset-button',
  AI_CHAT_RESET_CONFIRM = 'ai-chat-reset-confirm',
  AI_CHAT_INPUT_PLACEHOLDER = 'ai-chat-input-placeholder',
  AI_CHAT_THINKING = 'ai-chat-thinking',
