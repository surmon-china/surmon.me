      ...
      <div class="navbar-container container">
        <div class="navbar-header">
          ...
          <svg version="1.1"
               ...
               style="enable-background:new 0 0 560.5 87.9;"
               xml:space="preserve">
            <path class="logo-st"
                  d="M205.6,77.2l3.5-9.1c1.8,1.4,4,2.5,6.7,3.4s5,1.4,7.1,1.4c3.7,0,6.7-1.1,9-3.2s3.4-4.8,3.4-8.1
            ...
            <path class="logo-st"
                  d="M255.8,7.8h9.5v49.8c0,4.4,1.4,8.1,4.1,11s6.3,4.3,10.7,4.3c4.7,0,8.4-1.4,11.1-4.2c2.7-2.8,4.1-6.6,4.1-11.3
            ...
            <path class="logo-st"
                  d="M358,80.5l-18.7-31.2c-2.1,0-5.5-0.2-10.1-0.5v31.7h-9.5V7.8c0.4,0,2.8-0.1,7.4-0.4c4.6-0.3,7.9-0.4,10-0.4
            ...
            <path class="logo-st"
                  d="M428.7,80.5l-8.3-46.7l-15.3,47.7h-2.4L387,33.8l-8.1,46.7h-9.1L383,7.8h4.3l16.7,53l15.4-53.1h4.3l14.2,72.8
              C437.8,80.5,428.7,80.5,428.7,80.5z"/>
            <path class="logo-st"
                  d="M442.1,43.5c0-10.5,2.5-19.3,7.6-26.4s11.9-10.6,20.6-10.6c9.7,0,17.1,3.3,22.3,9.8c5.2,6.5,7.8,15.6,7.8,27.3
            ...
            <path class="logo-st"
                  d="M556.6,81.5l-36.1-53.2v52.2h-9.1V7.8h3.8l35.2,50.3V7.8h9.1v73.8C559.4,81.5,556.6,81.5,556.6,81.5z"/>
            <path class="logo-st"
                  d="M48.6,81.4l-4.3,4.3c-0.5,0.5-1.1,0.8-1.8,0.8s-1.4-0.3-2-0.8L0.9,46C0.3,45.4,0,44.7,0,44s0.3-1.4,0.9-2
            ...
            <path class="logo-st"
                  d="M113.7,3.7L78,86.4c-0.2,0.5-0.7,1-1.5,1.3S75,88,74.3,87.8l-5.8-1c-0.9-0.2-1.5-0.6-1.9-1
            ...
            <path class="logo-st"
                  d="M173.4,46l-39.6,39.6c-0.6,0.5-1.3,0.8-2,0.8s-1.4-0.3-2-0.8l-4.3-4.3c-0.5-0.6-0.8-1.3-0.8-2s0.3-1.4,0.8-2
