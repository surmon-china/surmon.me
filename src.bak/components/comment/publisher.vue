          ...
          <div v-if="Boolean(replyPid)" class="will-reply">
            <div class="reply-user">
              <span class="reply-text">
                ...
                <button class="reply-user-name" @click.prevent="scrollToComment(replyingComment.id)">
  ...
  export default defineComponent({
    ...
    setup(props, context) {
      ...
      const replyingComment = computed(() => {
        return store.state.comment.comments.data.find((comment) => comment.id === props.replyPid)
      })
