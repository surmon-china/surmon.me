  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const wallpapers = computed<any[]>(() =>
        store.getters[getNamespace(Modules.Wallpaper, WallpaperModuleGetters.Papers)](i18n.language.value)
      )
      ...
      onMounted(() => {
        store.dispatch(getNamespace(Modules.Wallpaper, WallpaperModuleActions.FetchPapers))
      })
